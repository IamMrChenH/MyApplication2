 ...
 */
public class GetAllViolation extends BaseAction {
    // action name
    public static final String TAG = "GetAllViolation";

    private Context context;

    public GetAllViolation(Context context) {
    ...
    protected String jasonPorcess(String param) {
        ...
        try {
            ...
            List<Violation> violations = DatabaseUtil.getAllV(context);
